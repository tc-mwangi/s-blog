...
class Config:
    ...
    MAIL_PORT = 587
    MAIL_USE_TLS = True
    MAIL_USERNAME = os.environ.get("MAIL_USERNAME") or 'saber.dangermouse@gmail.com'
    MAIL_PASSWORD = os.environ.get("MAIL_PASSWORD") or 'cartoonroyalty'
    SUBJECT_PREFIX = 'Sojourner'
